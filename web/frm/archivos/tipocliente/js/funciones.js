function agregarTipoCliente(){
    ...
    $.ajax({
        ...
        success:function(json){
            ...
            $("#nombre_tipocliente").val("");
            $("#id_tipocliente").focus();
            $("#id_tipocliente").select();
        },
        error: function(e){
    ...
    $.ajax({
        ...
        success: function(json){
            ...
            if(json.nuevo==="true"){
                ...
                siguienteCampo("#nombre_tipocliente","#botonAgregar",false);
            }
            else{
...
function buscarNombreTipoCliente(){
    ...
    $.ajax({
        ...
        success: function(json){
            ...
            $("tbody tr").on("click", function(){
                ...
                $("#panelBuscar").html("");
                $("#id_tipocliente").val(id);
                $("#nombre_tipocliente").focus();
                buscarIdTipoCliente();
                $("#buscar").fadeOut("slow");
